...
class Ui_MediaPipeTongueSettings(object):
    def setupUi(self, MediaPipeTongueSettings):
        ...
        MediaPipeTongueSettings.resize(508, 330)
        ...
        self.verticalLayout.addWidget(self.filter_settings_zone_lb)
        ...
        self.verticalLayout.addWidget(self.mincutoff_lb)
        ...
        self.verticalLayout.addWidget(self.mincutoff_dsb)

        self.beta_lb = QLabel(self.centralwidget)
        self.beta_lb.setObjectName(u"beta_lb")

        self.verticalLayout.addWidget(self.beta_lb)
        ...
        self.verticalLayout.addWidget(self.beta_dsb)
    ...
    def retranslateUi(self, MediaPipeTongueSettings):
        MediaPipeTongueSettings.setWindowTitle(QCoreApplication.translate("MediaPipeTongueSettings", u"MainWindow", None))
